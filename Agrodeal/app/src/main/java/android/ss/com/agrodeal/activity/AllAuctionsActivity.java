...
public class AllAuctionsActivity extends AppCompatActivity {
    ...
    Context context = AllAuctionsActivity.this;
    private String TAG = AllAuctionsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Shareprefrance.getUserType(context).equals("broker"))
        {
            ...
            Retro.getInterface(context).brokerBiddings(brokerId,new Callback<GenralResponse>() {
                @Override
