...
public class SoldActivity extends AppCompatActivity {
    ...
    Context context = SoldActivity.this;
    private RecyclerView recyclerView;
    private SoldAdapter sAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_soldCrops);

        sAdapter = new SoldAdapter(soldList,this);
        ...
        int farmerId = Integer.parseInt(Shareprefrance.getUserId(context));
        final ProgressDialog progressDialog = new ProgressDialog(context);

        Retro.getInterface(context).soldCrops(farmerId,new Callback<GenralResponse>() {
            @Override
