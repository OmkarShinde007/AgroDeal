...
public class ReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rAdapter = new ReviewAdapter(reviewList,"dealer");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (reviewStr.length() > 0 && ratingStr.length() > 0) {
                    ...
                    if(Double.parseDouble(ratingStr)<5.0) {

                        Retro.getInterface(context).addReview(Shareprefrance.getUserId(context), dealerId, reviewStr, "dealer", ratingStr, new Callback<GenralResponse>() {
                            @Override
                    ...
                    {
                        Toast.makeText(context, "Highest allowed points are 5.0", Toast.LENGTH_SHORT).show();
        ...
        Retro.getInterface(context).viewDealer(dealerId,new Callback<DealerResponse>() {
            @Override
            public void success(DealerResponse dealerResponse, Response response) {
                progressDialog.dismiss();

                if (dealerResponse.getResult().equalsIgnoreCase("success")) {

                    ReviewResponse reviewResponse[] = dealerResponse.getJarray();
